...
public class DesafiorRefeitoMetodos {

	public static void main(String[] args) throws FileNotFoundException {
		InputStream arquivo = new FileInputStream("texto.txt");
		PrintStream salvarArquivo = new PrintStream("textoAlterado.txt");
...
//	----------------------------------------- PROGRAMA -----------------------------------------	
		...
		while (leitorLinhas.hasNextLine()) {
			...
			while (leitorPalavras.hasNext()) {
				...
				textoModificado = textoModificado + textoFinal(palavras, palavraSelecionada);
			...
			salvarArquivo.println(textoModificado);
		}
	...
	static String textoFinal(String palavras, String palavraSelecionada) {
	...
	static void exibirTextoOriginal() throws FileNotFoundException {
		Scanner leitorParaExibirTextoNoConsole = new Scanner(new FileInputStream("texto.txt"));
